...
return [
    ...
    */
    ...
    |
    */
    'model_target_path'   => base_path('app/Models/Eloquent/Entities'),

    'controller_target_path'   => base_path('app/Http/Controllers/Application'),
    
    'event_target_path'   => base_path('app/Events'),
    
    'listener_target_path'   => base_path('app/Listeners'),
